unit TSS_BE_TTransparentPanel_unit;

interface

uses

  Classes, SysUtils,  Forms, Controls, Graphics,  types, Windows;
...
type
  ...
  protected
    ...
    procedure WMWindowPosChanged(var Message: MWindowPosChanged); message LM_WINDOWPOSCHANGED;
