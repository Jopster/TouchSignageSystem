...
{-----------------------------------------------
 DsFancyButton Release 2.1 for Delphi 3/4/5
 Copyright (c) 1999-2001 by Djoko Susilo
...
uses
  system.SysUtils, Windows, Messages, system.Classes, vcl.Graphics, vcl.Controls, vcl.Forms; //, DsgnIntf;
